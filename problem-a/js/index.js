...
function renderTrack(track) {
  ...
  ele.src = track.artworkUrl100;
  ele.alt = track.trackName;
  ele.title = track.trackName;
  recordsDiv.appendChild(ele);
}
...
const URL_TEMPLATE =
  "https://itunes.apple.com/search?entity=song&limit=25&term={searchTerm}";
...
function renderError(err) {
  ...
  document.getElementById("records").appendChild(errorMessage);
}
